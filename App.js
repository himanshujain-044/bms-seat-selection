...
// import SeatsSelectionTabel from './components/tabel/SeatsSelectionTabel.js';
import TabelRow from './components/UI/TabelRow';
export default function App() {
    ...
    return (
        <View style={styles.container}>
            <Text>Welcome BMS APP !</Text>

            <TabelRow />

            {/* <ScrollView horizontal> */}
            {/* <SeatsSelectionTabel data={a} /> */}
